...
- Is an entirely static application, doesn't require any server-based deployment (**NOTE:** If you want to run the app locally, use a static web server such as the nodejs [http-server](https://www.npmjs.com/package/http-server))
